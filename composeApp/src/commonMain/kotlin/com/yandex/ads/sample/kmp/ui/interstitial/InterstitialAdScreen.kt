package com.yandex.ads.sample.kmp.ui.interstitial
...
@Composable
fun InterstitialAdScreen(navController: NavHostController) {
    val networks = NetworkProvider.interstitialNetworks
    ...
    Scaffold(
        topBar = {
            SampleTopAppBar(title = "Interstitial Ad", onBack = { navController.popBackStack() })
        },
    ) { innerPadding ->
        Column(
            modifier = Modifier
